...
class TeachersSubjectControllerTest {
    ...
    public void create_return201_ifInputsIsValid() throws Exception {
        ...
        mockMvc.perform(post("/teachersSubjects")
    ...
    public void findById_return200_ifInputsIsValid() throws Exception {
        mockMvc.perform(get("/teachersSubjects/{id}", teachersSubjectDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void findById_return404_ifInputIdNotExist() throws Exception {
        Mockito.when(teachersSubjectService.findById(Long.MAX_VALUE)).thenThrow(EntityNotFoundException.class);
        mockMvc.perform(get("/teachersSubjects/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
    ...
    public void deleteById_return200_ifInputsValid() throws Exception {
        mockMvc.perform(delete("/teachersSubjects/{id}", teachersSubjectDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        Mockito.verify(teachersSubjectService, Mockito.times(1))
    ...
    public void deleteById_return404_ifInputIdNotExist() throws Exception {
        Mockito.doThrow(EntityNotFoundException.class).when(teachersSubjectService).deleteById(Long.MAX_VALUE);
        mockMvc.perform(delete("/teachersSubjects/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
    ...
    public void stopTeachSubjectById_return200_ifInputsValid() throws Exception {
        mockMvc.perform(put("/teachersSubjects/stopTeachSubject/{id}", teachersSubjectDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        Mockito.verify(teachersSubjectService, Mockito.times(1))
    ...
    public void stopTeachSubjectById_return404_ifInputIdNotExist() throws Exception {
        Mockito.doThrow(EntityNotFoundException.class).when(teachersSubjectService)
                .stopTeachSubjectById(Long.MAX_VALUE);
        mockMvc.perform(put("/teachersSubjects/stopTeachSubject/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
}
