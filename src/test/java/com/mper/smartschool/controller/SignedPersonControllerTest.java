...
class SignedPersonControllerTest {
    ...
    public void create_return201_ifInputsIsValid() throws Exception {
        ...
        mockMvc.perform(post("/smartschool/signedPersons")
    ...
    public void update_return200_ifInputsIsValid() throws Exception {
        mockMvc.perform(put("/smartschool/signedPersons/{id}", signedPersonDto.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(signedPersonDto)))
    ...
    public void update_return404_ifIdNotExist() throws Exception {
        ...
        Mockito.when(signedPersonService.update(signedPersonDto)).thenThrow(new NotFoundException("", null));
        mockMvc.perform(put("/smartschool/signedPersons/{id}", signedPersonDto.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(signedPersonDto)))
    ...
    public void update_return400_ifIdIsNull() throws Exception {
        mockMvc.perform(put("/smartschool/signedPersons/null")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(signedPersonDto)))
                .andExpect(status().isBadRequest());
    }
    ...
    public void findAll_return200() throws Exception {
        mockMvc.perform(get("/smartschool/signedPersons")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void findById_return200_ifInputsIsValid() throws Exception {
        mockMvc.perform(get("/smartschool/signedPersons/{id}", signedPersonDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void findById_return404_ifInputIdNotExist() throws Exception {
        Mockito.when(signedPersonService.findById(Long.MAX_VALUE)).thenThrow(new NotFoundException("", null));
        mockMvc.perform(get("/smartschool/signedPersons/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
    ...
    public void deleteById_return200_ifInputsValid() throws Exception {
        mockMvc.perform(delete("/smartschool/signedPersons/{id}", signedPersonDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void deleteById_return404_ifInputIdNotExist() throws Exception {
        Mockito.doThrow(new NotFoundException("", null)).when(signedPersonService).deleteById(Long.MAX_VALUE);
        mockMvc.perform(delete("/smartschool/signedPersons/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
}
