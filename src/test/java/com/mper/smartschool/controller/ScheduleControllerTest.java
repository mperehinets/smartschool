...
class ScheduleControllerTest {
    ...
    public void create_return201_ifInputsIsValid() throws Exception {
        ...
        mockMvc.perform(post("/smartschool/schedules")
    ...
    public void update_return200_ifInputsIsValid() throws Exception {
        mockMvc.perform(put("/smartschool/schedules/{id}", scheduleDto.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(scheduleDto)))
    ...
    public void update_return404_ifIdNotExist() throws Exception {
        ...
        Mockito.when(scheduleService.update(scheduleDto)).thenThrow(new NotFoundException("", null));
        mockMvc.perform(put("/smartschool/schedules/{id}", scheduleDto.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(scheduleDto)))
    ...
    public void update_return400_ifIdIsNull() throws Exception {
        mockMvc.perform(put("/smartschool/schedules/null")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(scheduleDto)))
                .andExpect(status().isBadRequest());
    }
    ...
    public void findAll_return200() throws Exception {
        mockMvc.perform(get("/smartschool/schedules")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void findById_return200_ifInputsIsValid() throws Exception {
        mockMvc.perform(get("/smartschool/schedules/{id}", scheduleDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void findById_return404_ifInputIdNotExist() throws Exception {
        Mockito.when(scheduleService.findById(Long.MAX_VALUE)).thenThrow(new NotFoundException("", null));
        mockMvc.perform(get("/smartschool/schedules/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
    ...
    public void deleteById_return200_ifInputsValid() throws Exception {
        mockMvc.perform(delete("/smartschool/schedules/{id}", scheduleDto.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        Mockito.verify(scheduleService, Mockito.times(1))
    ...
    public void deleteById_return404_ifInputIdNotExist() throws Exception {
        Mockito.doThrow(new NotFoundException("", null)).when(scheduleService).deleteById(Long.MAX_VALUE);
        mockMvc.perform(delete("/smartschool/schedules/{id}", Long.MAX_VALUE)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }
}
